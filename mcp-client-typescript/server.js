  ...
  async (args) => {
    try {
      ...
      try {
        ...
        console.error(
          `Checked IPs against URLhaus: ${
            urlhausThreats.length
          } threats found - ${urlhausThreats.join(", ") || "None"}`
        )
      } catch (e) {
  ...
  async (args) => {
    try {
      ...
      try {
        ...
        console.error(
          `IP ${ip} checked against URLhaus: ${
            isThreat ? "Threat found" : "No threat found"
          }`
        )
      } catch (e) {
        console.error(`Failed to fetch URLhaus data: ${e.message}`)
